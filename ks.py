#!/usr/bin/python2
#coding=utf-8
#This Script Is Written By Kashi
  #=================================#
  # Kashi-Teach The Official Programmrer  #   #                                 #
  #                                 #
  #=================================#
...
\033[1;97m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█
\033[1;32m⊱• ────────────  ──────────── •⊰
\033[1;96m≫ \033[1;96m CODDED BY :\033[1;96m Kashi Teaches
\033[1;96m≫ \033[1;96m FACEBOOK:\033[1;94m Kashi 
\033[1;96m≫ \033[1;96m YOUTUBE :\033[1;92m Kashi Teaches
...
\033[1;96m≫ \033[1;96m Whtsapp  Num +923062045786
...
jalan('\033[1;32m⊱• ──────────── ──────────── ──────────── •⊰')
jalan('\033[1;31mTHE OFFICIAL HACKER KASHI ARAIN') 
jalan('\033[1;31mTHIS TOOL IS OWNER KASHI-TRICKER') 
jalan('\033[1;31mSO GUYS YOU FOLLOWS OUR THIS TOOL') 
jalan('\033[1;31mIF YOU HAVE ANY PROBLEM YOU CANTACT IN MY WHATSAPP NUMBER')
jalan('\033[1;31mMy Whtsapp Num +923062045786')
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;32mACCESS GRANTED AS " + username #Dev:Kashi-Teach
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;93mKASHI-TEACH THE OFFICIAL PROGRAMMER[ P•O•P ]"
...
def pilih_super():
	...
	if peak =="":
		...
		print """\033[1;32m⊱• ───────── TECH-ABM THE OFFICIAL PROGRAMMER[ T.A.B] ───────── •⊰"""
	...
	print """
\033[1;32m⊱• ───────── KASHI-TEACH THE OFFICIAL PROGRAMMER───────── •⊰
\033[1;32m⊱• ─────────ITX GIFT MY BEST SUBCRIBERS [KASHI-TEACHES] SO DON'T COPY OVER SCRIPT  ───────── •⊰
─────█─▄▀█──█▀▄─█──
────▐▌──────────▐▌──
────█▌▀▄──▄▄──▄▀▐█──
───▐██──▀▀──▀▀──██▌──
──▄████▄──▐▌──▄████▄─"""
	...
	p.map(main, id)
	print "\033[1;32m⊱• ──────────── ──────────── ──────────── •⊰"
	print "  \033[1;93m⊱•─── Developed By Kashi-Teach─── •⊰" #Dev:Kashi'Teach
	print '\033[1;96m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 kashi.py)↩\033[1;97m....'
...
Checkpoint ID Open After 7 Days
 Having Problem Whatsapp Me :+923062045786"""
